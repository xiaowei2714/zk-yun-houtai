...
<!--            <el-button v-perms="['order_job/add']" type="primary" @click="handleAdd">-->
<!--                <template #icon>-->
...
<!--            </el-button>-->
            <el-tabs v-model="queryParams.type" @tab-click="handleClick">
                ...
                <el-tab-pane label="话费" :name="1"></el-tab-pane>
                <el-tab-pane label="电费" :name="2"></el-tab-pane>
            </el-tabs>
<!--            <el-button-->
<!--                v-perms="['order_job/delete']"-->
...
<!--                    <el-table-column label="类型" prop="type" show-overflow-tooltip />-->
                    ...
                    <el-table-column label="产品" prop="product_id" show-overflow-tooltip />
...
<script lang="ts" setup name="orderJobLists">
import { usePaging } from '@/hooks/usePaging'
import { useDictData } from '@/hooks/useDictOptions'
import { apiOrderJobLists, apiOrderJobDelete } from '@/api/order_job'
